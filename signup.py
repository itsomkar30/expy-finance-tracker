...
def sign_up_page():
    ...
    welcome_label = tk.Label(frame, text="Welcome!", fg="#601E88", bg="#ffffff", anchor="w", justify="left",
                             font=nunito2)
    welcome_label.pack(anchor="w", pady=(40, 0), padx=(80, 0))
    ...
    add_placeholder_password(new_pass_entry, "Enter Password")
    ...
    add_placeholder_password(new_pass_entry_confirm, "Confirm Password")

    new_username_entry = tk.Entry(input_frame, fg="black", width=24, font=entryfont)
    new_username_entry.grid(row=5, columnspan=2, sticky="nw", pady=(20, 0), padx=(10, 0))
    add_placeholder(new_username_entry, "Enter your name")
    ...
    def signup_database():
        ...
        if new_password == new_password_confirm:
            try:
                user = auth.create_user_with_email_and_password(new_email, new_password)  # Stored in user variable here
    ...
    signup = tk.Button(input_frame, text="Sign up", bg="#601E88", fg="white", command=signup_database, width=24,
                       font=entryfont)
    signup.grid(row=6, columnspan=3, sticky="nw", pady=(25, 0), padx=(10, 0))
    ...
    go_to_signin_label = tk.Label(input_frame, text="Try Log-in instead", fg="blue", bg="#ffffff", anchor="center",
